...
class UIManager extends React.PureComponent<IUIManagerProps, IUIManagerState> {
  ...
  constructor(props: IUIManagerProps, state: IUIManagerState) {
    ...
    translationSvc.init().then(r => null);
    ...
    window.addEventListener('click', (e) => {
      ...
      if (el.classList.contains('ui-click-sound')) {
    ...
    document.body.addEventListener('keyup', e => {
      if (this.state.currentUiStateID !== UIStates.GAME
        && this.state.currentUiStateID !== UIStates.MENU) {
        return false;
      }
  ...
  render() {
    ...
    return (
      <div className='ui' style={{ display: configSvc.quality === GraphicsQuality.PHOTO ? 'none' : 'unset' }}>
  ...
  getState(): UIStates {
    return this.state.currentUiStateID;
  }
