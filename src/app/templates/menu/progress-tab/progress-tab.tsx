    ...
    return (
      <div className='tab progress-tab'>
        ...
        <div className='tab__content'>
          <H4 className='mb-2 sub-title'>{translationSvc.translate('UI.progress-tab.title_biomes')}</H4>
          ...
          <H4 className='mb-2 sub-title'>{translationSvc.translate('UI.progress-tab.title_stats')}</H4>
