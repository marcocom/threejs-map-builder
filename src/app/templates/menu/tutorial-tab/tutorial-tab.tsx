...
class TutorialTab extends React.Component<any, ITutorialTabsState> {
      ...
      <Article className='page page--1 pb-2'>
        ...
        <Row className='mt-3 mb-2'>
          <Col className='flexcol--24 flex justify-content--begin'>
            <Button className='btn--orange btn--expand-mobile btn--rounded' onClick={this.reset}>{translationSvc.translate('UI.tutorial-tab.tab1.reset_btn')}</Button>
          </Col>
        </Row>
  ...
  /*
  * this was a kind of about-page with technologies used and etc.  removing and uninstalling slick-carousel
  * */
  getSecondPanel() {
    return (
