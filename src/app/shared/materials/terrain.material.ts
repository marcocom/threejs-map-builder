...
const PARAMETERS_CL = {
  ...
  specular: new THREE.Color(0x252525),
  shininess: 6,
  reflectivity: 0.2,
  flatShading: true,
  wireframe: false,
...
export const TERRAIN_MATERIAL: THREE.MeshPhongMaterial = new THREE.MeshPhongMaterial(PARAMETERS as THREE.MeshPhongMaterialParameters);
