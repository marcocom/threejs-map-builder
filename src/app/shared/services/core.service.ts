            ...
            if (child instanceof THREE.Mesh) {
              ...
              if (!(child.material instanceof THREE.Material)) {
                child.material.forEach(material => {
                  ...
                  if (element.tex != null) material.map = texLoader.load(element.tex);
                  if (element.alpha != null) material.alphaMap = texLoader.load(element.alpha);
                });
              } else {
                child.material.flatShading = true;
                if (element.doubleSide === true) child.material.side = THREE.DoubleSide;

                if (element.tex != null) child.material.map = texLoader.load(element.tex);
                if (element.alpha != null) child.material.alphaMap = texLoader.load(element.alpha);
