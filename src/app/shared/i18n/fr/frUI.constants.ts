...
export const FR_UI_TRANSLATION: IUITranslationKeys = {
  ...
  'home-tab': {
    ...
    article: {
      ...
      p1: 'Mapp Builder est un projet visant à générer aléatoirement des mondes 3D interactifs. Ces mondes constituent un canevas ayant servis à intégrer divers algorithmes vus dans le cadre du cours d’Intelligence Artificielle de 3ème à l’IMAC.',
    ...
    copy_clipboard: 'Cliquez pour copier dans votre presse-papiers.'
  },
  'credits-tab': {
    title: 'Crédits',
