  ...
  buildGeometry(): THREE.BufferGeometry {
    ...
    for (let col = 0; col < this.parameters.nCols; col++) {
      for (let row = 0; row < this.parameters.nRows; row++) {
        ...
        const x1 = (geometry.getIndex().getX(a) + geometry.getIndex().getX(b) + geometry.getIndex().getX(d)) / 3;
        const x2 = (geometry.getIndex().getX(d) + geometry.getIndex().getX(c) + geometry.getIndex().getX(a)) / 3;

        const y1 = (geometry.getIndex().getY(a) + geometry.getIndex().getY(b) + geometry.getIndex().getY(d)) / 3;
        const y2 = (geometry.getIndex().getY(d) + geometry.getIndex().getY(c) + geometry.getIndex().getY(a)) / 3;

        const z1 = (geometry.getIndex().getZ(a) + geometry.getIndex().getZ(b) + geometry.getIndex().getZ(d)) / 3;
        const z2 = (geometry.getIndex().getZ(d) + geometry.getIndex().getZ(c) + geometry.getIndex().getZ(a)) / 3;
