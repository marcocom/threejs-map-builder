...
class Weather {
  ...
  */
  ...
  initLights() {
    ...
    (<THREE.Mesh>this.sun.children[0]).material = new THREE.MeshLambertMaterial({ color: 0xffec83, emissive: 0x505050, emissiveIntensity: 1.0, reflectivity: 0.5 });
    ...
    (<THREE.Mesh>this.moon.children[0]).material = new THREE.MeshLambertMaterial({ color: 0x83d8ff, emissive: 0x505050, emissiveIntensity: 1.0, reflectivity: 0.5 });
