...
class Weather {
  ...
  private static PHASES: IPhase[] = [
    ...
    { name: 'day', value: 22, daylight: 1.0, boundLightIntensity: 0.0, fogColor: '#93c9ff', skyColor: '#3a6aa0', groundColor: '$color-pearl' },
    { name: 'day', value: 157, daylight: 1.0, boundLightIntensity: 0.0, fogColor: '#93c9ff', skyColor: '#3a6aa0', groundColor: '$color-pearl' },
    { name: 'dusk', value: 180, daylight: 0.5, boundLightIntensity: 0.65, fogColor: '#475d73', skyColor: '#3a6aa0', groundColor: '#e86b4a' }, // dusk
    { name: 'night', value: 202, daylight: 0.0, boundLightIntensity: 0.0, fogColor: '#212C37', skyColor: '#3a6aa0', groundColor: '$color-pearl' },
    { name: 'night', value: 337, daylight: 0.0, boundLightIntensity: 0.0, fogColor: '#212C37', skyColor: '#3a6aa0', groundColor: '$color-pearl' },
  ];
