...
import TestBiome from '@app/world/biomes/TestBiome';
...
class BiomeGenerator {
  ...
  init(terrain: Terrain): Biome {
    switch (terrain.getWorld().getSeed().toLowerCase()) {
      case 'whitebox':
        this.biome = new WhiteboxDemoBiome(terrain);
        break;
      // case 'test':
      //   this.biome = new TestBiome(terrain);
      //   break;
      case 'taiga':
      case 'taiga1':
      case 'taiga2':
      ...
      case 'mountain3':
      case 'mountain4':
        this.biome = new MountainBiome(terrain); // replaced highland
        break;
      case 'ocean':
      case 'ocean1':
      case 'ocean2':
